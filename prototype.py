...
# ============================================================
# -------- Base Directory (important for PyInstaller) -------- #
# ============================================================
...
# ============================================================
# --------- Portable Tesseract Paths (REQUIRED) -------------- #
# ============================================================
TESSERACT_PATH = os.path.join(TESSERACT_DIR, "tesseract.exe")
TESSDATA_DIR = os.path.join(TESSERACT_DIR, "tessdata")

# Point pytesseract to bundled executable
pytesseract.pytesseract.tesseract_cmd = TESSERACT_PATH

# Tell Tesseract where its language files live
...
# ============================================================
# ----------- MAWB Number Extraction Function ---------------- #
# ============================================================
